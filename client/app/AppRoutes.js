...
const AppRoutes = () => {
  ...
  // Detemine if/how a user is logged in
...
const dispatch = useDispatch();
  ...
  // Available routes when a client is logged in
  if (clientIsLoggedIn) {
    return (
      <div>
        <Routes>
          ...
          />
          <Route
            path="/freelancers/most"
            element={<MostReviewedFreelancers />}
          />
 ...
 // Available routes when a Freelancer is logged in
  if (freelancerIsLoggedIn) {
    return (
      <div>
        <Routes>
          ...
          <Route
            path="/messages/:id"
            element={<IndividualMessagesFreelancer />}
          />
    ...
    // available routes when no one is logged in
    return (
      <Routes>
        <Route path="/" element={<Home />} />
        <Route path="/home" element={<Home />} />
