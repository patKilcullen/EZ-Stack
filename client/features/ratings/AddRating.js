...
import {
  fetchRatingByFreelancerAndProject,
  selectSingleRating,
} from "./singleRatingSlice";
...
const AddRating = (props) => {
  ...
  const freelancer = useSelector(
    (state) => state.singleProject.singleProject.freelancer
  );
  ...
  const handlePostRating = (e) => {
    ...
    dispatch(addRatingAsync({ freelancerId, rating, review, projectId })).then(
            ...
            <Card sx={{ width: 500, margin: "10%", marginLeft: 0 }}>
              ...
              <Typography variant="body2" color="primary">
                {singleRating.singleRating.rating === 1 ? (
                  ...
                  <p>{"★★"}</p>
                ) : singleRating.singleRating.rating === 3 ? (
                  <p>{"★★★"}</p>
                ) : singleRating.singleRating.rating === 4 ? (
                  <p>{"★★★★"}</p>
                ) : singleRating.singleRating.rating === 5 ? (
                  <p>{"★★★★★"}</p>
                ) : null}
              </Typography>
              <Typography variant="body2" color="primary">
